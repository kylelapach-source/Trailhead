...
insert into activities (id, title, description, domain, age_tags, supply_list, zone_suggestion, is_seed_data, difficulty) values

-- SCIENCE / NATURE (6)
('a001', 'Dinosaur Excavation Dig',
...
-- MATH READINESS (6)
('a007', 'Cinderblock & Plank Road Builder',
...
('a023', 'Trail Walk Scavenger Hunt',
